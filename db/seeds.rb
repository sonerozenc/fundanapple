...
projects = Project.create([
  ...
  { :title => 'Kim wedding present', :description => 'We are getting a Macbook for this very special day.', :image_url => 'http://lorempixel.com/600/400/', :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-19 11:34:00 UTC', :end_time => '2013-07-19 11:34:00 UTC', :user => users[1] },
  { :title => 'Juan leaving do', :description => 'We are getting a Macbook for this very special day.', :image_url => 'http://lorempixel.com/600/400/', :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-19 11:34:00 UTC', :end_time => '2013-07-19 11:34:00 UTC', :user => users[1] },
  { :title => 'Sam starts his new job', :description => 'We are getting a Macbook for this very special day.', :image_url => 'http://lorempixel.com/600/400/', :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-19 11:34:00 UTC', :end_time => '2013-07-19 11:34:00 UTC', :user => users[1] },
])
