...
projects = Project.create([
  { :title => 'John the Romantic', :description => 'John is turning 35 this year. Confirmed by various resources, we have been told that John desperately needs a new MacBook. Here is our chance to contribute to this wonderful gift.', :file => File.open(File.join(Rails.root, 'db', 'fixtures', 'mac_romantic.jpg')), :video_url => 'video.com', :target_price => '1000', :start_time => '2013-05-19 11:34:00 UTC', :end_time => '2013-06-19 11:34:00 UTC', :user => users[0] },
  { :title => 'Ben the DJ', :description => 'Ben Rocks! Buy a lovely MacBook for the king of the club scene in London.', :file => File.open(File.join(Rails.root, 'db', 'fixtures', 'mac_dj.jpg')), :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-19 11:34:00 UTC', :end_time => '2013-07-12 11:34:00 UTC', :user => users[1] },
  { :title => 'Adam the Geek', :description => 'Adam is a real geek. No, seriously. Check out the dodgy stickers on his MacBook. Now he needs the real shit! Help us make this happen...', :file => File.open(File.join(Rails.root, 'db', 'fixtures', 'mac_geek.jpg')), :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-25 11:34:00 UTC', :end_time => '2013-07-19 11:34:00 UTC', :user => users[1] },
  { :title => 'Jackie the Student', :description => 'Jackie Chan arrived London couple of months back. His MacBook has been imported from China. Let s get him a real London version.', :file => File.open(File.join(Rails.root, 'db', 'fixtures', 'mac_student.jpg')), :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-10 11:34:00 UTC', :end_time => '2013-07-19 11:34:00 UTC', :user => users[1] },
  { :title => 'Dan the Instructor', :description => 'This man is a serious actor in the startup scene. He literally attends every single meetup, gathering, party around programming. Show your love by putting your artwork on his new MacBook.', :file => File.open(File.join(Rails.root, 'db', 'fixtures', 'mac_instructor.jpg')), :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-12 23:34:00 UTC', :end_time => '2013-07-19 11:25:00 UTC', :user => users[1] },
  { :title => 'Jenny the Fashionista', :description => 'This lady loves hanging around cafes, markets, meeting new hipsters of all sorts. Watch her video to be part of her new MacBook purchase.', :file => File.open(File.join(Rails.root, 'db', 'fixtures', 'mac_fashionista.jpg')), :video_url => 'video.com', :target_price => '2000', :start_time => '2013-06-06 09:34:00 UTC', :end_time => '2013-07-19 11:12:00 UTC', :user => users[1] },
])
